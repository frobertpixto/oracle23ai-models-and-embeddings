WITH
  ...
  source_movies AS (
    SELECT 'Apocalypse Now (1979)' AS title FROM DUAL UNION ALL
    SELECT 'Inception (2010)' AS title FROM DUAL UNION ALL
    SELECT 'Arrival (2016)' AS title FROM DUAL UNION ALL
    SELECT 'My Life as a Dog (Mitt liv som hund) (1985)' AS title FROM DUAL UNION ALL
    SELECT 'Other Guys, The (2010)' AS title FROM DUAL
  ),
